# -*- coding: utf-8 -*-
"""
KD240 EtherCAT Virtual Heater PI Controller GUI v4.5 - Operator UI / Report Layout Fix
...
# GUI class
# =========================================================
class KD240HeaterGuiV45:
    def __init__(self, root):
        self.root = root
        self.root.title("KD240 EtherCAT Virtual Heater PI Controller v4.5")
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            header,
            text="KD240 EtherCAT Virtual Heater PI Controller v4.5",
            bg=self.bg,
            fg=self.text,
        ...
        subtitle = tk.Label(
            self.root,
            text="WMX I/O Space | RxPDO 14 byte / TxPDO 48 byte | RUN/STOP | Auto Tune v4.5 | Tuned Gain Display",
            bg=self.bg,
            fg=self.subtext,
            font=("Segoe UI", 10)
        )
        ...
        self.state_box.grid_rowconfigure(0, weight=1, minsize=58)
        ...
        self.state_badge.grid(row=0, column=0, sticky="nsew", padx=(8, 8), pady=8)
        ...
        self.state_desc.grid(row=0, column=1, sticky="nsew", padx=(10, 8), pady=8)
        ...
        self.lbl_stable_time.grid(row=0, column=2, sticky="nsew", padx=(0, 8), pady=8)
        ...
        # Graph card
        plot_card = self.make_card(left, "Live Trend v4.5")
    ...
    def connect(self):
        ...
        try:
            ...
            ret = self.wmx.SetDeviceName("KD240HeaterGuiV45")
    ...
    def show_analysis_report_window(self):
        ...
        report.geometry("900x790")
        report.minsize(820, 740)
        ...
        rows_frame.pack(fill="both", expand=True, padx=12, pady=(0, 14))
