# -*- coding: utf-8 -*-
"""
KD240 EtherCAT Virtual Heater PI Controller GUI v4.2 - Operator UI / Production-Ready Polish
...
# GUI class
# =========================================================
class KD240HeaterGuiV42:
    def __init__(self, root):
        self.root = root
        self.root.title("KD240 EtherCAT Virtual Heater PI Controller v4.2")
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            header,
            text="KD240 EtherCAT Virtual Heater PI Controller v4.2",
            bg=self.bg,
            fg=self.text,
        ...
        subtitle = tk.Label(
            self.root,
            text="WMX I/O Space | RxPDO 14 byte / TxPDO 48 byte | RUN/STOP | Auto Tune v4.2 | Tuned Gain Display",
            bg=self.bg,
            fg=self.subtext,
            font=("Segoe UI", 10)
        )
        ...
        # Graph card
        plot_card = self.make_card(left, "Live Trend v4.2")
    ...
    def connect(self):
        ...
        try:
            ...
            ret = self.wmx.SetDeviceName("KD240HeaterGuiV42")
