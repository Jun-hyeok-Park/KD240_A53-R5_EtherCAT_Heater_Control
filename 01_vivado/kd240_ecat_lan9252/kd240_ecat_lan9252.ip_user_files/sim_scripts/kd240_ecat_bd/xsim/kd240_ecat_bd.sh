...
#
# Script generated by Vivado on Tue May 19 10:19:26 +0900 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : kd240_ecat_bd.sh
...
#
# Usage        : kd240_ecat_bd.sh
#                kd240_ecat_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                kd240_ecat_bd.sh [-rerun]
#                kd240_ecat_bd.sh [-reset_run]
#                kd240_ecat_bd.sh [-clean]
#                kd240_ecat_bd.sh [-reset_log]
#                kd240_ecat_bd.sh [-help]
#
...
# script info
echo -e "kd240_ecat_bd.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./kd240_ecat_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xbip_utils_v3_0_15 axi_utils_v2_0_11 xbip_pipe_v3_0_11 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_24 floating_point_v7_1_21)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb kd240_ecat_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./kd240_ecat_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: kd240_ecat_bd.sh [-help]\n\
Usage: kd240_ecat_bd.sh [-step]\n\
Usage: kd240_ecat_bd.sh [-lib_map_path]\n\
Usage: kd240_ecat_bd.sh [-rerun]\n\
Usage: kd240_ecat_bd.sh [-reset_run]\n\
Usage: kd240_ecat_bd.sh [-clean]\n\
Usage: kd240_ecat_bd.sh [-reset_log]\n\
Usage: kd240_ecat_bd.sh [-keep_index]\n\
Usage: kd240_ecat_bd.sh [-noclean_files]\n\n\
