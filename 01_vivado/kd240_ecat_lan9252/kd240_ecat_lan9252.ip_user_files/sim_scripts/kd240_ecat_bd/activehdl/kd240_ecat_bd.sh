...
#                script (type 'kd240_ecat_bd.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/user/Desktop/KD240/01_vivado/kd240_ecat_lan9252/kd240_ecat_lan9252.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
