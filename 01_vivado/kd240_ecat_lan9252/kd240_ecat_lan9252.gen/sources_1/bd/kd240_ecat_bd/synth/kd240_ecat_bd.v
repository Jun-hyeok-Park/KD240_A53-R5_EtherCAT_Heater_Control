...
//Command     : generate_target kd240_ecat_bd.bd
//Design      : kd240_ecat_bd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "kd240_ecat_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=kd240_ecat_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=11,da_board_cnt=1,da_clkrst_cnt=3,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "kd240_ecat_bd.hwdef" *) 
module kd240_ecat_bd
   (irq_in_0,
    rst_out_0,
    spi_rtl_io0_i,
    spi_rtl_io0_o,
  ...
  wire ecat_pl_if_0_irq_int;
  wire ecat_pl_if_0_sync0_int;
  wire ecat_pl_if_0_sync1_int;
  wire irq_in_0;
  wire rst_out_0;
  ...
  kd240_ecat_bd_axi_quad_spi_0_0 axi_quad_spi_0
       (.ext_spi_clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .ss_o(spi_rtl_ss_o),
        .ss_t(spi_rtl_ss_t));
  kd240_ecat_bd_axi_smc_0 axi_smc
  ...
  kd240_ecat_bd_ecat_pl_if_0_0 ecat_pl_if_0
       (.irq_in(irq_in_0),
        .irq_int(ecat_pl_if_0_irq_int),
        .rst_out(rst_out_0),
        ...
        .sync0_in(sync0_in_0),
        .sync0_int(ecat_pl_if_0_sync0_int),
        .sync1_in(sync1_in_0),
        .sync1_int(ecat_pl_if_0_sync1_int));
  kd240_ecat_bd_heater_axi_0_0 heater_axi_0
       (.s00_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  kd240_ecat_bd_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  kd240_ecat_bd_xlconcat_0_0 xlconcat_0
       (.In0(ecat_pl_if_0_irq_int),
        .In1(ecat_pl_if_0_sync0_int),
        .In2(ecat_pl_if_0_sync1_int),
        .dout(xlconcat_0_dout));
  kd240_ecat_bd_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
