...
#ifndef _kd240_ecat_bd_xlconcat_0_0_core_h_
#define _kd240_ecat_bd_xlconcat_0_0_core_h_
...
class kd240_ecat_bd_xlconcat_0_0_core : public sc_module 
{
    public: 
       kd240_ecat_bd_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(kd240_ecat_bd_xlconcat_0_0_core);
    ...
    virtual ~kd240_ecat_bd_xlconcat_0_0_core() = default;
