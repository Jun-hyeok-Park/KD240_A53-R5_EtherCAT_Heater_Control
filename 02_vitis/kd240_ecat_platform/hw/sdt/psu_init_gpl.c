...
/*##################################################################### */
    ...
    * Reserved. Return zeroes on reads.
    *  PSU_DDR_PHY_MR14_VREF_DQ                                    0x2e

    * LPDDR4 Mode Register 14
    * (OFFSET, MASK, VALUE)      (0XFD0801B8, 0xFFFFFFFFU ,0x0000006EU)
    */
	PSU_Mask_Write(DDR_PHY_MR14_OFFSET, 0xFFFFFFFFU, 0x0000006EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_VTCR0_DVINIT                                    0x2e

    * VREF Training Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD080528, 0xFFFFFFFFU ,0xF10329EEU)
    */
	PSU_Mask_Write(DDR_PHY_VTCR0_OFFSET, 0xFFFFFFFFU, 0xF10329EEU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00000020U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00000020U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180154, 0x03FFFFFFU ,0x00080814U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL0_OFFSET,
		0x03FFFFFFU, 0x00080814U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03F7F7EBU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03F7F7EBU);
/*##################################################################### */
...
unsigned long psu_ddr_phybringup_data(void)
{
	...
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	Xil_Out32(0xFD070014U, 0x00000C4DU);
	Xil_Out32(0xFD070010U, 0x80000018U);
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	while ((regval & 0x1) != 0x0) {
	/***MRSTAT***/
	...
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	Xil_Out32(0xFD070014U, 0x00000E6EU);
	Xil_Out32(0xFD070010U, 0x80000018U);
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	while ((regval & 0x1) != 0x0) {
	/***MRSTAT***/
	...
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	Xil_Out32(0xFD070014U, 0x00001606U);
	Xil_Out32(0xFD070010U, 0x80000018U);
